...
export HADOOP_OPTS="-Djava.library.path=/opt/big-data/hadoop-3.3.4/lib/native"
export HDFS_NAMENODE_USER=hadoop0
export HDFS_DATANODE_USER=hadoop0
export HDFS_SECONDARYNAMENODE_USER=hadoop0
export YARN_RESOURCEMANAGER_USER=hadoop0
export YARN_NODEMANAGER_USER=hadoop0
